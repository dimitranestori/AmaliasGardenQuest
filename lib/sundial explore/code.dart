...
class CodeAnimation extends StatefulWidget {
  ...
  @override
  _CodeAnimationState createState() => _CodeAnimationState();
}
...
class _CodeAnimationState extends State<CodeAnimation>
  ...
  final String fullText = "The second digit is...";
  int number = 2; // Το νούμερο που θα εμφανιστεί
            ...
            children: [
              ...
              IconButton(
                onPressed: () {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => SundialScreen()),
                  );
                },
                tooltip: 'Previous',
                icon:
