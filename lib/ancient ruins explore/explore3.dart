...
class _MyHomePageState extends State<MyHomePage> {
  ...
  performImageLbeling() async {
    ...
    if (containsPlant) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => AncientRuinsScreen()),
      );
    } else {
      // Update message if not Washingtonia filifera
      setState(() {
        resultMessage = "This is not the Ancient Ruins";
      });
    }
  }
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Center(
            child: Text(
              'Take a picture of ancient ruins to find out what they are..',
