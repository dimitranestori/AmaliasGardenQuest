...
class _MyHomePageState extends State<MyHomePage> {
  ...
  performImageLbeling() async {
    ...
    if (containsPlant) {
      // Navigate to Washinftonia screen
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => WashingtoniaPalmsScreen()),
      );
    } else {
      // Update message if not Washingtonia filifera
      setState(() {
        resultMessage = "This is not Washingtonia filifera";
      });
    }
  }
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Center(
            child: Text(
              'Take a picture of tree-lined path.',
