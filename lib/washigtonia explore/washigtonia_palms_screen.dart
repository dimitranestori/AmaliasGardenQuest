...
import 'washingtonia_palms_controller.dart';
...
class WashingtoniaPalmsScreen extends StatelessWidget {
  const WashingtoniaPalmsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final InfoController_washingtonia infoController =
        Get.put(InfoController_washingtonia());
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: Obx(() =>
                Image.asset(infoController.currentImage, fit: BoxFit.cover)),
          ),
          Positioned(
            top: 0,
            left: 0,
      ...
      bottomNavigationBar: SizedBox(
        height: 50,
        child: BottomAppBar(
          color: const Color.fromARGB(255, 36, 119, 39).withOpacity(0.85),
          child: Row(
