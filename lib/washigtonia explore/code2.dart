...
import 'washigtonia_palms_screen.dart';
import 'dart:async';
...
class CodeAnimation2 extends StatefulWidget {
  const CodeAnimation2({super.key});

  @override
  _CodeAnimation2State createState() => _CodeAnimation2State();
}

class _CodeAnimation2State extends State<CodeAnimation2>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _numberScaleAnimation;
  String displayedText = "";
  final String fullText = "The first digit is...";
  int number = 1; // Το νούμερο που θα εμφανιστεί
            ...
            children: [
              ...
              IconButton(
                onPressed: () {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (context) => WashingtoniaPalmsScreen()),
                  );
                },
                tooltip: 'Previous',
                icon:
