...
class CodeAnimation5 extends StatefulWidget {
  const CodeAnimation5({super.key});

  @override
  _CodeAnimation5State createState() => _CodeAnimation5State();
}

class _CodeAnimation5State extends State<CodeAnimation5>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _numberScaleAnimation;
  String displayedText = "";
  final String fullText = "The fifth digit is...";
  int number = 5; // Το νούμερο που θα εμφανιστεί
            ...
            children: [
              ...
              IconButton(
                onPressed: () {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (context) => AmaliasRockScreen()),
                  );
                },
                tooltip: 'Previous',
                icon:
