...
class CodeAnimation4 extends StatefulWidget {
  const CodeAnimation4({super.key});

  @override
  _CodeAnimation4State createState() => _CodeAnimation4State();
}

class _CodeAnimation4State extends State<CodeAnimation4>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _numberScaleAnimation;
  String displayedText = "";
  final String fullText = "The fourth digit is...";
  int number = 4; // Το νούμερο που θα εμφανιστεί
            ...
            children: [
              ...
              IconButton(
                onPressed: () {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (context) => SamarasInfoScreen2()),
                  );
                },
                tooltip: 'Previous',
                icon:
